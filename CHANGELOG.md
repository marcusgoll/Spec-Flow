...
### Fixed
- npm package now properly excludes internal workflow files (release.md, x-announcement.md)
- package.json files array updated with explicit file listing and negation patterns
- .npmignore created for additional protection against accidental exposure
