...
- _Lint check_ lint errors (ESLint, Ruff)
- _Type check_ type errors (TypeScript, MyPy)
- _Tests_ test failures (Jest, Pytest)
- _Build_ compilation errors (Next.js)
- _E2E_ Playwright failures
- _Deploy_ Vercel/Railway errors
- _Smoke_ Health check failures
...
# Frontend bugs
Task(frontend-dev): "PR #${PR_NUMBER}: Fix ${COMPONENT}
TypeScript: ${ERROR}
Context: ${CODE}"
