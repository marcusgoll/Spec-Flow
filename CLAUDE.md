...
**Maximal Decomposition**: Smaller tasks = higher reliability
- Score 1-3 (Atomic): ~95% success
- Score 4-6 (Compound): ~85% success
- Score 7-10 (Complex): ~70% success → DECOMPOSE

**First-to-ahead-by-k Voting**: Multiple agents vote, k-ahead wins
- Formula: `p_correct = p^k / (p^k + (1-p)^k)`
- k=2 with 70% agents → 84% accuracy

**Red-Flagging**: Discard suspicious outputs, don't repair
