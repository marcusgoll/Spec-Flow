...
- If production code bug: Report to implementer (backend-dev/frontend-shipper), mark task as blocked
...
- Alert frontend-shipper if component prop validation is insufficient
