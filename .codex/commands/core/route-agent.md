...
- Use this routing logic to decide how you personally execute the next steps; do not call Task.
- Run any suggested shell steps directly and keep execution sequential.
- Ask the user inline if routing signals are ambiguous.
</codex_compatibility>
