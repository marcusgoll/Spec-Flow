...
<codex_compatibility>
Codex cannot invoke Task or AskUserQuestion tools. Apply `CODEX_COMPATIBILITY.md`:
- Ask clarifying questions inline.
- Execute all steps yourself (no Task subagents), sequentially.
- Use the shell commands provided instead of slash commands.
</codex_compatibility>
