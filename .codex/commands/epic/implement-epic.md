...
<codex_compatibility>
Codex cannot invoke Task, SlashCommand, or AskUserQuestion tools. Apply `CODEX_COMPATIBILITY.md`:
- Execute the shell steps directly instead of slash commands.
- Perform sprint “parallel” launches sequentially yourself, keeping the grouping.
- Ask any clarifications inline.
- Load referenced skills via `node .codex/skills/test-skill-call.js <name>` as needed.
</codex_compatibility>
