...
<codex_compatibility>
Codex cannot use AskUserQuestion. Ask the same batches of questions inline, then continue with the responses. Run the included shell commands (or `python .spec-flow/scripts/spec-cli.py clarify ...`) instead of relying on slash commands.
</codex_compatibility>
