...
<codex_compatibility>
Codex cannot call SlashCommand or AskUserQuestion tools. Apply `CODEX_COMPATIBILITY.md`:
- Run the bash/PowerShell snippets directly (or `python .spec-flow/scripts/spec-cli.py spec ...`) instead of `/spec`.
- Ask clarification questions inline in chat using the same batches/options this file lists.
</codex_compatibility>
