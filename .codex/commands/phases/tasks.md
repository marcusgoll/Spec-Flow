...
- Run the shell commands here (or `python .spec-flow/scripts/spec-cli.py tasks ...`) directly.
- Ask any gating questions inline.
- Execute any “parallel” Task steps sequentially yourself and record outcomes in the feature files.
</codex_compatibility>
